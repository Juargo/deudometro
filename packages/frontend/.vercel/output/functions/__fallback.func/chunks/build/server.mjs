import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, inject, computed, unref, shallowRef, hasInjectionContext, getCurrentInstance, defineAsyncComponent, createElementBlock, provide, cloneVNode, h, Suspense, nextTick, mergeProps, shallowReactive, ref, Fragment, createApp, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, withCtx, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { p as parseURL$1, i as encodePath$1, k as decodePath, l as hasProtocol, m as isScriptProtocol, f as joinURL, w as withQuery, n as defu, s as sanitizeStatusCode, o as getContext, $ as $fetch$1, q as createHooks, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_C5Yny9pBbNHO4DGAlYzMJNZnVpe7J8QQlnaQBtvlIZE = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-qBTIVhvX.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./login-C2UYBT5P.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./register-hJEK8dCW.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-C7-3O3J4.mjs')
  },
  {
    name: "debts-new",
    path: "/debts/new",
    component: () => import('./new-CZXG7OGu.mjs')
  },
  {
    name: "debts-id",
    path: "/debts/:id()",
    component: () => import('./_id_-BY-cpMLb.mjs'),
    children: [
      {
        name: "debts-id-pay",
        path: "pay",
        component: () => import('./pay-DfaIL-Lg.mjs')
      },
      {
        name: "debts-id-edit",
        path: "edit",
        component: () => import('./edit-BhuOsHu8.mjs')
      }
    ]
  },
  {
    name: "plan",
    path: "/plan",
    component: () => import('./index-d2BIZnYh.mjs')
  },
  {
    name: "debts",
    path: "/debts",
    component: () => import('./index-BZ2djMi8.mjs')
  },
  {
    name: "space",
    path: "/space",
    component: () => import('./index-BdBlZMJt.mjs')
  },
  {
    name: "plan-history",
    path: "/plan/history",
    component: () => import('./history-KS32aDqM.mjs')
  },
  {
    name: "profile-edit",
    path: "/profile/edit",
    component: () => import('./edit-BYP-Ihlv.mjs')
  },
  {
    name: "plan-strategy",
    path: "/plan/strategy",
    component: () => import('./strategy-B788vU7a.mjs')
  },
  {
    name: "profile-setup",
    path: "/profile/setup",
    component: () => import('./setup-D6Othu4g.mjs')
  },
  {
    name: "invite-token",
    path: "/invite/:token()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./_token_-0xsc6QmE.mjs')
  },
  {
    name: "payments",
    path: "/payments",
    component: () => import('./index-DiTdAiV4.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./reset-password-B5dECy60.mjs')
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta || {},
    component: () => import('./forgot-password-B8Dzc20m.mjs')
  },
  {
    name: "milestones",
    path: "/milestones",
    component: () => import('./index-0uC10cnO.mjs')
  }
];
...
const useAuthStore = defineStore("auth", {
  ...
  actions: {
    setSession(token, user, financialSpace, role) {
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  ...
  if (authStore.isLoading) {
    [__temp, __restore] = executeAsync(() => authStore.initialize()), await __temp, __restore();
  }
...
const revive_payload_server_j0iuCkkGLDOd6UhVGORHU4UwVMbTGwDFUBcGYED07uA = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_C5Yny9pBbNHO4DGAlYzMJNZnVpe7J8QQlnaQBtvlIZE,
  plugin$1,
  revive_payload_server_j0iuCkkGLDOd6UhVGORHU4UwVMbTGwDFUBcGYED07uA,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4
];
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-mUpGWDqr.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CRsEAgS7.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-52YIeyjN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BrdbPFwc.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.2_@emnapi+runtime@1.9.2_@parcel+watcher@2.5.6_@types+node@25.5.2_6qlg3fu2f3us4obbcevsrz52au/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.2_@emnapi+runtime@1.9.2_@parcel+watcher@2.5.6_@types+node@25.5.2_6qlg3fu2f3us4obbcevsrz52au/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0 as a, useRoute$1 as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, useRouter as e, encodeRoutePath as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useAuthStore as u };
